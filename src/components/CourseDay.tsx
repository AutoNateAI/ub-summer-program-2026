      ...
      <section className="grid grid-cols-12 gap-6">
        <div className="col-span-12 space-y-6 lg:col-span-8">
          <div className="overflow-hidden rounded-xl border border-[#c3c7cb] bg-white shadow-sm">
            <div className="relative flex aspect-video items-center justify-center overflow-hidden bg-[#182732] p-8 text-center text-white">
              ...
              <div className="relative z-10 max-w-2xl">
                ...
                <h3 className="mt-5 font-[Hanken_Grotesk,Inter,sans-serif] text-4xl font-black leading-tight">
                  {day.slideTitle}
                </h3>
                <p className="mt-3 text-lg font-semibold text-[#64fade]">
                  {day.slideKicker}
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-3 border-t border-[#c3c7cb] bg-[#f2f4f5] px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2 text-sm font-semibold text-[#43474b]">
                <Sparkles className="h-4 w-4 text-[#006b5c]" />
                Slide deck integrated into the course window
              </div>
